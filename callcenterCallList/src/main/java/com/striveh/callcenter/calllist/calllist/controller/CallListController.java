...
/**
 * @功能:【callList 】controller @项目名:callcentercallList @作者:xxx @日期:2020-04-06 12:05:43 @说明：
 *
 * <pre></pre>
 */
@RestController
...
public class CallListController extends BaseController<CallListPojo> {
  ...
  /** callList service */
  @Autowired private ICallListService callListService;
  ...
  @RequestMapping("/get")
  public void get(
      CallListPojo callList, HttpServletRequest request, HttpServletResponse response) {}

  @RequestMapping("/inner/getListByCallListId")
  public List<CallListPojo> getListByCallListId(
    ...
    if (callListId > 100) {
      try {
        ...
        if (jsonObject.getBooleanValue("success")) {
          return JsonTool.getList(
              jsonObject.getJSONObject("data").getString("list"), CallListPojo.class);
        } else {
          return null;
        }
      } catch (Exception e) {
