...
public class DateTool {
  ...
  /**
   * 判断时间是否在两个时段（时分秒）中间 isBetweenTime("10:30:00","15:00:00") isBetweenTime("15:00:00","10:30:00")
   *
   * @param startStr
   * @param endStr
   * @return
  ...
  public static boolean isBetweenTime(Date date, String startStr, String endStr) {
    ...
    if (e.after(s)) {
      ...
      return isBetweenTime(date, s.getTime(), e1.getTime())
          || isBetweenTime(date, s1.getTime(), e.getTime());
    }
  }
