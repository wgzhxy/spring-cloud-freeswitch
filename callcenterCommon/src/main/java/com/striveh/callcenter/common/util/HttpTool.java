...
public class HttpTool {
  ...
  public static String requestGet(
    ...
    try {
      HttpClientBuilder httpClientBuilder =
          getHttpClientBuilder(sslContext, headers, connectTimeout, socketTimeout);
   ...
   * @throws Exception
   */
  public static String requestPost(SSLContext sslContext, String url, String str, ContentType type)
      throws Exception {
    return requestPost(
        sslContext,
        url,
  ...
  public static String requestPost(
      SSLContext sslContext, String url, Map<String, String> headers, String str, ContentType type)
      throws Exception {
    return requestPost(
        sslContext,
        url,
   ...
   * @throws Exception
   */
  public static String requestPost(SSLContext sslContext, String url, Map<String, String> parames)
      throws Exception {
    return requestPost(
        sslContext,
        url,
   ...
   */
  public static String requestPost(
      SSLContext sslContext, String url, Map<String, String> headers, Map<String, String> parames)
      throws Exception {
    return requestPost(
        sslContext,
        url,
   ...
   */
  public static String requestPost(
      SSLContext sslContext, String url, InputStream inputStream, ContentType type)
      throws Exception {
    return requestPost(
        sslContext,
        url,
   ...
   * @throws Exception
   */
  public static InputStream requestPostAndInputStream(
      SSLContext sslContext,
      String url,
      Map<String, String> headers,
      Map<String, String> parames,
      ...
      byte[] sealdata)
      throws Exception {
    return requestPostWithInputStream(
        sslContext,
        null,
        null,
        url,
   ...
   * @throws Exception
   */
  public static InputStream requestPostWithInputStream(
      SSLContext sslContext,
    ...
    if (parames != null) {
      ...
      while (paramIterator.hasNext()) {
        ...
        entityBuilder.addTextBody(
            paramEntry.getKey(), paramEntry.getValue(), ContentType.create("text/plain", charset));
      }
    }
    // 发送的文件
   ...
   * @throws Exception
   */
  private static InputStream postWithInputStream(
      SSLContext sslContext,
      Credentials credentials,
      HttpHost targetHost,
      String url,
  ...
  private static HttpClientBuilder getHttpClientBuilder(
      SSLContext sslContext, Map<String, String> headers, int connectTimeout, int socketTimeout) {
   ...
   * @throws Exception
   */
  public static SSLContext getSSLContextFromStream(InputStream instream, String keyStorepass)
      throws Exception {
    try {
   ...
   * @return
   */
  public static <T> T getObjectFromCookie(
      HttpServletRequest request, String cookieName, Class<T> object) {
   ...
   * @throws Exception
   */
  public static Map<String, Object> getParameterFromStream(HttpServletRequest request)
      throws Exception {
  ...
  public static void httpResponse(
      HttpServletResponse response, Object obj, ResponseContentType type, String encode) {
   ...
   * @return
   */
  public static String getParameterFromRequest(
