...
/** 项目：callcenter 日期：2020年4月6日 作者：striveh 功能： */
public enum ERedisCacheKey {
  ...
  CALLCENTER_AGENT_WORK_STATUS_SESSION_AFTER(
      "callcenterAgentWorkStatusSessionAfter_", "通话结束后坐席的状态"),
  ...
  CALLCENTER_AGENT_SESSION_EVALUATION_PLAYBACK(
      "callcenterAgentSessionEvaluationPlayback_", "坐席通话评分防误触"),
   ...
   * @param name
   */
  ERedisCacheKey(String code, String name) {
    this.code = code;
    this.name = name;
  }
