...
public class HttpClientTool {
  ...
  public static String get(
    ...
    // getResponse(sslContext,httpClientContext,url,headers,charsetStr,keepAlive,connectTimeout,socketTimeout);
  ...
  public static String postJson(
      SSLContext sslContext, String url, Map<String, String> headers, String str) throws Exception {
   ...
   * @throws Exception
   */
  public static String postJson(SSLContext sslContext, String url, String str, ContentType type)
      throws Exception {
    return requestPost(
        sslContext,
        null,
   ...
   * @throws Exception
   */
  public static String postParames(SSLContext sslContext, String url, Map<String, String> parames)
      throws Exception {
   ...
   * @throws Exception
   */
  public static String postParames(
  ...
  public static HttpClientContext getHttpClientContext(
      Credentials credentials, HttpHost targetHost) {
