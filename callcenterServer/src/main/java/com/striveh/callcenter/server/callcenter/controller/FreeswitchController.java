...
/**
 * @功能:【freeswitch freeswitch服务实例表】controller @项目名:callcenterServer @作者:xxx @日期:2020-05-17
 * 16:54:05 @说明：
 *
 * <pre></pre>
 */
...
public class FreeswitchController extends BaseController<FreeswitchPojo> {
  ...
  @RequestMapping("/get")
  public void get(
      FreeswitchPojo freeswitch, HttpServletRequest request, HttpServletResponse response) {}
