...
public class ChannelAnswerEslEventHandler implements EslEventHandler {
  ...
  public void handle(String addr, EslEvent event) {
    log.info(
        "ChannelAnswerEslEventHandler handle addr[{}] EslEvent[{}].",
        addr,
    ...
    if (StringUtils.isNotBlank(event.getEventHeaders().get("variable_return_visit"))
      ...
      userinfoPojo.setDestinationUUID(body.get("callId"));
      msgOperations.convertAndSend(
          "/topic/callExtStatus/" + event.getEventHeaders().get("variable_callcenter_project_code"),
          userinfoPojo);
      ...
      msgOperations.convertAndSend(
          "/topic/notify/" + event.getEventHeaders().get("Caller-Destination-Number"),
