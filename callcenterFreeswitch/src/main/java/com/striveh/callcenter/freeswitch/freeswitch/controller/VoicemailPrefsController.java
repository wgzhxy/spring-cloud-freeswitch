...
/**
 * @功能:【voicemail_prefs 】controller @项目名:callcenterFreeswitch @作者:xxx @日期:2020-04-06 10:35:32 @说明：
 *
 * <pre></pre>
 */
@RestController
...
public class VoicemailPrefsController extends BaseController<VoicemailPrefsPojo> {
  ...
  @Autowired private IVoicemailPrefsService voicemailPrefsService;
  ...
  @RequestMapping("/get")
  public void get(
      VoicemailPrefsPojo voicemailPrefs,
