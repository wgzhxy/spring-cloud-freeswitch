...
/**
 * @功能:【gateway 】controller @项目名:callcenterFreeswitch @作者:xxx @日期:2020-04-06 10:35:30 @说明：
 *
 * <pre></pre>
 */
@RestController
...
public class GatewayController extends BaseController<GatewayPojo> {
  ...
  /** gateway service */
  @Autowired private IGatewayService gatewayService;

  @Autowired private ICallTaskServiceApi callTaskServiceApi;
