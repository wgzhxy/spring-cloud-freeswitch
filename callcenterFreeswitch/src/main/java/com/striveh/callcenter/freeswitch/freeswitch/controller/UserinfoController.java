...
/**
 * @功能:【userinfo 】controller @项目名:callcenterFreeswitch @作者:xxx @日期:2020-04-06 10:35:32 @说明：
 *
 * <pre></pre>
 */
@RestController
...
public class UserinfoController extends BaseController<UserinfoPojo> {
  ...
  @RequestMapping("/get")
  public void get(
      UserinfoPojo userinfo, HttpServletRequest request, HttpServletResponse response) {}
  ...
  public List<UserinfoPojo> getListByProjectIdAndStatus(
      @RequestParam Long projectId, @RequestParam Integer status) {
    UserinfoPojo userinfoPojo = new UserinfoPojo();
    userinfoPojo.setProjectId(projectId);
